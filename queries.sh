...
echo "$($PSQL "SELECT name FROM teams AS t JOIN games AS g ON t.team_id = g.winner_id OR t.team_id = g.opponent_id WHERE year = 2014 AND round = 'Eighth-Final' ORDER BY t.name;")"
